...
public class Parabola{
    ...
    */
    ...
    static func getLeft(p:Parabola)->Parabola?{
        return getLeftChild(getLeftParent(p));

    }
    
    ///Returns the closest right leaf of the tree
    static func getRight(p:Parabola)->Parabola?{
        return getRightChild(getRightParent(p));

    }
    
    ///Returns the closest parent which is on the left
    static func getLeftParent(p:Parabola)->Parabola?{
        var par	= p.parent!;
        var pLast = p;
    ...
    static func getRightParent(p:Parabola)->Parabola?{
        var par	= p.parent!;
        var pLast = p;
    ...
    static func getLeftChild(pin:Parabola?)->Parabola?{
        if let p = pin{
            var par = p.left;
            while(!par.isLeaf){
                par = par.right;
    ...
    static func getRightChild(pin:Parabola?)->Parabola?{
        if let p = pin{
            var par = p.right;
            while(!par.isLeaf){
                par = par.left;
